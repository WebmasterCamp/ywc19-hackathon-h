...
export const CaroselResturant = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        onClick={handlePrev}
        className="absolute -left-5 top-1/2 z-[100] flex h-6 w-6 cursor-pointer items-center justify-center rounded-full "
      >
        <svg
          width="24"
          height="25"
      ...
      <div
        onClick={handleNext}
        className="absolute -right-5 top-1/2 z-[100] flex h-6 w-6 cursor-pointer items-center justify-center rounded-full "
      >
        <svg
          width="24"
          height="24"
