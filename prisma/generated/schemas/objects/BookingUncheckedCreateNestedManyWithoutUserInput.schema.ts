...
const Schema: z.ZodType<Prisma.BookingUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const BookingUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
