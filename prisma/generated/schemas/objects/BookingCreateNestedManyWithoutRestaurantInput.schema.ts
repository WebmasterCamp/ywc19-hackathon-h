...
const Schema: z.ZodType<Prisma.BookingCreateNestedManyWithoutRestaurantInput> =
  z
    .object({
      create: z
        .union([
...
export const BookingCreateNestedManyWithoutRestaurantInputObjectSchema = Schema;
