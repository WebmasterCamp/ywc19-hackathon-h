...
const Schema: z.ZodType<Prisma.BookingUncheckedUpdateManyWithoutRestaurantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BookingUncheckedUpdateManyWithoutRestaurantNestedInputObjectSchema =
  Schema;
