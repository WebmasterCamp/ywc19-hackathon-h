...
const Schema: z.ZodType<Prisma.BookingUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => BookingUpsertWithWhereUniqueWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => BookingUpsertWithWhereUniqueWithoutUserInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => BookingUpdateWithWhereUniqueWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => BookingUpdateWithWhereUniqueWithoutUserInputObjectSchema
...
export const BookingUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
